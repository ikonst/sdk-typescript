...
- The TS SDK can be executed on Node 14.18+, 16, 18, 20 and 22. However, for SDK development, we recommend using the active LTS version (i.e. Node 20 at this time). For easier testing, you may want to use a version manager, such as: [nvm](https://github.com/nvm-sh/nvm/blob/master/README.md) or [volta](https://volta.sh/).
